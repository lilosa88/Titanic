...
We encounter 3 columns with missing value: Age, Cabin and Embarked. 
 ...
 - The column Age has 177 missing values out of 891. In order to fill the missing information we made use of the column Title. We impute the age using the median age for all people with the same title. The column Age was converted into categorical variables. 
